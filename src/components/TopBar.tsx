    ...
    <>
      <header className="bg-card border-b border-border sticky top-0 z-40 backdrop-blur-md">
        <div className="flex items-center justify-between px-4 lg:px-8 py-4">
          ...
          {/* Search Bar - Desktop */}
          <div className="hidden lg:flex items-center gap-3 bg-muted rounded-lg px-4 py-2.5 w-full max-w-md border border-border focus-within:border-orange-500 focus-within:ring-2 focus-within:ring-orange-500/20 transition">
            ...
            <input
              ...
              className="bg-transparent border-none outline-none text-sm text-foreground placeholder-[hsl(var(--muted-foreground))] w-full"
            />
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          {/* User Profile */}
          <button className="flex items-center gap-3 px-3 py-2 hover:bg-muted rounded-lg transition">
