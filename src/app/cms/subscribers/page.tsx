    ...
    <PageContainer>
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div className="flex-1">
          ...
          <p className="text-neutral-400 text-sm">Manage your email subscriber list</p>
        </div>
        <button
          onClick={exportSubscribers}
          className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-neutral-800 text-neutral-300 font-medium hover:bg-neutral-700 transition-colors"
        >
          <Download size={18} />
          Export CSV
        </button>
            ...
            <tbody className="divide-y divide-neutral-800">
              {filteredSubscribers.map((subscriber) => (
                <tr key={subscriber.id} className="hover:bg-neutral-800/30 transition-colors">
                  ...
                  <td className="px-5 py-4 text-neutral-400 hidden sm:table-cell">
                    {subscriber.name || '-'}
                  </td>
