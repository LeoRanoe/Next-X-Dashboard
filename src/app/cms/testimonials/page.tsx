    ...
    <PageContainer>
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div className="flex-1">
          ...
          <p className="text-neutral-400 text-sm">Manage customer reviews and testimonials</p>
        </div>
        <button
      ...
      {filteredTestimonials.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {filteredTestimonials.map((testimonial) => (
            <div
              key={testimonial.id}
              className={`bg-neutral-900 rounded-2xl border overflow-hidden transition-all ${
              ...
              <div className="p-5">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-neutral-800">
                  <div className="flex items-center gap-2">
                    ...
                    >
                      {testimonial.is_active ? <Eye size={16} /> : <EyeOff size={16} />}
                    </button>
                    <button
                    ...
                    >
                      <Star size={16} className={testimonial.is_featured ? 'fill-amber-400' : ''} />
                    </button>
                  </div>
